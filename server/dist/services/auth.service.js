 ...
 */
const forgotPassword = async (email, locale = index_1.env.locale) => {
    ...
    const args = {
        ...
        resetLink: (0, util_1.asset)(`/reset-password?token=${resetToken.token}`)
    };
    await (0, email_service_1.sendHTMLEmail)(findUser.email, (0, i18n_1.__)({ phrase: 'Reset your password', locale }), (0, html_1.generateHTML)(path_1.default.join(__dirname, `/../email.templates/reset.password.template/${locale}.html`), args), { attachments: [{ filename: 'logo.png', path: (0, util_1.frontendAsset)('images/logo.png'), cid: 'logo' }] }).catch(err => logger_1.logger.error((0, i18n_1.__)({ phrase: err.message, locale })));
    return findUser;
};
/**
